...
class InputValidator:
    """
    Lightweight input checks for API endpoints.
    """
    
    @staticmethod
    def validate_earthquake_input(data: Dict[str, Any]) -> List[str]:
        """
        Validate earthquake inputs and return any issues.
        """
        errors = []
    ...
    def validate_cyclone_input(data: Dict[str, Any]) -> List[str]:
        """
        Validate cyclone inputs and return any issues.
        """
        errors = []
    ...
    def validate_severity_input(data: Dict[str, Any]) -> List[str]:
        """
        Reuse cyclone validation for severity inputs.
        """
        # Same fields, same rules
